...
func (c *chatV1Client) Delete(ctx context.Context, in *DeleteChatRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (UnimplementedChatV1Server) Delete(context.Context, *DeleteChatRequest) (*empty.Empty, error) {
