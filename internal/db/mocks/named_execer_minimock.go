...
//go:generate minimock -i github.com/alexandrhub/grpc-chat/internal/db.NamedExecer -o ./mocks/named_execer_minimock.go -n NamedExecerMock
...
import (
	...
	mm_db "github.com/alexandrhub/grpc-chat/internal/db"
